...
After the pyth2wormhole contracts have been deployed to your BAS chain, please refer to the [Pyth on EVM-based chains documentation](../documentation/pythnet-price-feeds/evm.mdx) for how to consume price feeds.
