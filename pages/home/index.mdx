...
Pyth's market data is contributed by over [120+ first-party publishers](https://insights.pyth.network/publishers), including some of the biggest exchanges and market making firms in the world.
...
- [Price Feeds](../price-feeds) provide real-time prices for [1300+ assets](https://insights.pyth.network/price-feeds) on [100+ blockchain ecosystems](../price-feeds/contract-addresses), including Solana, many EVM chains,
