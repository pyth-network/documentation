# What is PYTH?
    ...
    - The "Approval Quorum" has been met. This is a percentage of staked tokens that must have voted yes for the proposal to pass. The threshold can vary depending on the type of proposal.  The current thresholds can be found in the "Governances" sections of the [parameters of the DAO](https://app.realms.today/dao/PYTH/params). It is expressed as a percentage of staked tokens at the start of the voting period for the proposal.
