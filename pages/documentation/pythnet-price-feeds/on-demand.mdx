...
Developers should get an instance of the [Hermes](hermes) from Hermes node providers to pull the price updates from. Hermes is a
permissionless service serveing price updates via a convenient web API.
