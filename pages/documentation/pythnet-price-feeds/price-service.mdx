...
** Price Service is going to deprecate soon. Pleaes consider using [Hermes](hermes), a complete rewrite of Price Service with the same API. **
...
Please find more information about building and running the price service [here][price-service-repo].
