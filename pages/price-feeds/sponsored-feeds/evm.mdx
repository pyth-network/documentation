...
- [Ink-Kraken Mainnet](#ink-kraken-mainnet)
...
The price feeds listed in the table below are currently sponsored in **Arbitrum mainnet**.

Update Parameters: **1 hour heartbeat or 0.5% price deviation**
...
The price feeds listed in the table below are currently sponsored in **Ink-Kraken mainnet**.
