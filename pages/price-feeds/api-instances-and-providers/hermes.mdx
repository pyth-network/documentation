...
Hermes Stable serves the Pythnet prices and Hermes Beta serves prices from Pythtest (Pythnet testnet). All mainnet
networks and all EVM testnet networks have access to the Hermes Stable.
