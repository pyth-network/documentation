...
2. Select the [Price Feed IDs](/price-feeds/price-feeds) for the assets you want to fetch prices for. Price feeds come in two varieties, Stable and Beta. You should select Stable feed ids
