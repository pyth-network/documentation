...
1. Get a Hermes instance from the list of providers [here](https://docs.pyth.network/price-feeds/api-instances-and-providers/hermes#node-providers). You can use the [Pyth Hermes](https://docs.pyth.network/price-feeds/api-instances-and-providers/hermes#node-providers) instance for development purposes.
