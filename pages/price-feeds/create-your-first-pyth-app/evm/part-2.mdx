...
In this part of the tutorial, we will deploy a Solidity contract that uses Pyth price feeds.
This is continuation of the [Create your first Pyth app on EVM](./part1) of the tutorial.
