...
In this part of the tutorial, we will create a contract that reads price from Pyth and uses it to calculate the amount of ETH required to mint an NFT.
...
`forge init` command will create several subdirectories within `contracts`.
