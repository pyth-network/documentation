...
The default provider fulfills the request by sending a transaction with a gas limit mentioned in above table. Entropy callbacks the consumer as part of this transaction.
