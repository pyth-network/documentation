...
Implement `entropyCallback` method which is required by the IEntropyConsumer Interface. Entropy calls it back to fulfill a request. Entropy will call back this 
