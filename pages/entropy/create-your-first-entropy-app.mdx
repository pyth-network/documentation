...
```bash copy
   fee          : 101
   tx           : 0x9faf2f439f99986b4a87befbad89301b3ec8976038a8b8332c7c53cbba43fd95
   sequence     : 36
   tx           : 0x806900dbbebc8488ac6b87c9c82c5fd9ad38231c2e66b1899e0a8a3afe805f01
   Flip Result  : Tails
```

Note that: the script can fail due to some api errors. You can run the script again to get the expected result. 
