...
contract CoinFlip {
  ...
  // This method is required by the IEntropyConsumer interface. It is called by Entropy when a request is fulfilled.
  function entropyCallback(
    uint64 sequenceNumber,
    // We are not using _providerAddress here.
...
Implement `entropyCallback` method for Entropy to call back once the request is fulfilled. Entropy will call back this 
