...
const acrechain = defineChainInfo({
  chainId: "acre_9052-1",
  currencies: [
    {
      coinDenom: "acre",
...
const andromeda = defineChainInfo({
  chainId: "andromeda-1",
  currencies: [
    {
      coinDenom: "andr",
...
const andromeda1 = defineChainInfo({
  chainId: "andromeda-1",
  currencies: [
    {
      coinDenom: "andr",
...
const assetmantle = defineChainInfo({
  chainId: "mantle-1",
  currencies: [
    {
      coinDenom: "mntl",
...
const bandchain = defineChainInfo({
...
const bitbadges = defineChainInfo({
  chainId: "bitbadges-1",
  currencies: [
    {
      coinDenom: "badge",
...
const bitcanna = defineChainInfo({
  chainId: "bitcanna-1",
  currencies: [
    {
      coinDenom: "bcna",
...
const bluzelle = defineChainInfo({
  chainId: "bluzelle-9",
  currencies: [
    {
      coinDenom: "bnt",
...
const celestia = defineChainInfo({
  chainId: "celestia",
  currencies: [
    {
      coinDenom: "tia",
...
const chain4energy = defineChainInfo({
  chainId: "perun-1",
  currencies: [
    {
      coinDenom: "c4e",
...
const chihuahua = defineChainInfo({
  chainId: "chihuahua-1",
  currencies: [
    {
      coinDenom: "huahua",
...
const chronicnetwork = defineChainInfo({
  chainId: "morocco-1",
  currencies: [
    {
      coinDenom: "cht",
...
const cnhostables = defineChainInfo({
...
const commercionetwork = defineChainInfo({
  chainId: "commercio-3",
  currencies: [
    {
      coinDenom: "commercio",
...
const composable = defineChainInfo({
  chainId: "centauri-1",
  currencies: [
    {
      coinDenom: "pica",
...
const conscious = defineChainInfo({
  chainId: "cvn_2032-1",
  currencies: [
    {
      coinDenom: "cvnt",
...
const crescent = defineChainInfo({
  chainId: "crescent-1",
  currencies: [
    {
      coinDenom: "cre",
...
const cryptoorgchain = defineChainInfo({
...
const doravota = defineChainInfo({
  chainId: "vota-ash",
  currencies: [
    {
      coinDenom: "DORA",
...
const dymension = defineChainInfo({
...
const empowerchain = defineChainInfo({
...
const fetchhub = defineChainInfo({
  chainId: "fetchhub-4",
  currencies: [
    {
      coinDenom: "fet",
...
const finschia = defineChainInfo({
  chainId: "finschia-2",
  currencies: [
    {
      coinDenom: "fnsa",
...
const firmachain = defineChainInfo({
  chainId: "colosseum-1",
  currencies: [
    {
      coinDenom: "fct",
...
const genesisl1 = defineChainInfo({
...
const gravitybridge = defineChainInfo({
...
const highbury = defineChainInfo({
...
const impacthub = defineChainInfo({
  chainId: "ixo-5",
  currencies: [
    {
      coinDenom: "ixo",
...
const injective = defineChainInfo({
  chainId: "injective-1",
  currencies: [
    {
      coinDenom: "INJ",
...
const konstellation = defineChainInfo({
  chainId: "darchub",
  currencies: [
    {
      coinDenom: "darc",
...
const likecoin = defineChainInfo({
...
const lumnetwork = defineChainInfo({
...
const medasdigital = defineChainInfo({
...
const omniflixhub = defineChainInfo({
...
const oraichain = defineChainInfo({
  chainId: "Oraichain",
  currencies: [
    {
      coinDenom: "ORAI",
...
const persistence = defineChainInfo({
  chainId: "core-1",
  currencies: [
    {
      coinDenom: "xprt",
...
const provenance = defineChainInfo({
...
const quicksilver = defineChainInfo({
...
const routerchain = defineChainInfo({
...
const secretnetwork = defineChainInfo({
  chainId: "secret-4",
  currencies: [
    {
      coinDenom: "scrt",
...
const sentinel = defineChainInfo({
...
const shareledger = defineChainInfo({
...
const sifchain = defineChainInfo({
  chainId: "sifchain-1",
  currencies: [
    {
      coinDenom: "ROWAN",
...
const sommelier = defineChainInfo({
  chainId: "sommelier-3",
  currencies: [
    {
      coinDenom: "somm",
...
const stafihub = defineChainInfo({
  chainId: "stafihub-1",
  currencies: [
    {
      coinDenom: "fis",
...
const stargaze = defineChainInfo({
  chainId: "stargaze-1",
  currencies: [
    {
      coinDenom: "stars",
...
const starname = defineChainInfo({
...
const synternet = defineChainInfo({
  chainId: "synternet-1",
  currencies: [
    {
      coinDenom: "SYNT",
...
const taketitan = defineChainInfo({
...
const teritori = defineChainInfo({
  chainId: "teritori-1",
  currencies: [
    {
      coinDenom: "tori",
...
const terpnetwork = defineChainInfo({
  chainId: "morocco-1",
  currencies: [
    {
      coinDenom: "terp",
...
const unification = defineChainInfo({
...
const zetachain = defineChainInfo({
...
const airchainstestnet = defineChainInfo({
  chainId: "junction",
  currencies: [
    {
      coinDenom: "AMF",
...
const akashtestnet = defineChainInfo({
  chainId: "sandbox-01",
  currencies: [
    {
      coinDenom: "akt",
...
const archwaytestnet = defineChainInfo({
...
const arkeonetworktestnet = defineChainInfo({
  chainId: "arkeo",
  currencies: [
    {
      coinDenom: "arkeo",
...
const artelatestnet = defineChainInfo({
...
const auratestnet = defineChainInfo({
  chainId: "aura_6321-3",
  currencies: [
    {
      coinDenom: "eaura",
...
const axelartestnet = defineChainInfo({
...
const babylontestnet = defineChainInfo({
  chainId: "bbn-test3",
  currencies: [
    {
      coinDenom: "bbn",
...
const babylontestnet1 = defineChainInfo({
  chainId: "bbn-test1",
  currencies: [
    {
      coinDenom: "bbn",
...
const bitcannadevnet = defineChainInfo({
...
const bitcannadevnet2 = defineChainInfo({
...
const cascadiatestnet = defineChainInfo({
...
const celestiatestnet = defineChainInfo({
...
const celestiatestnet2 = defineChainInfo({
  chainId: "arabica-11",
  currencies: [
    {
      coinDenom: "tia",
...
const celestiatestnet3 = defineChainInfo({
  chainId: "mocha-4",
  currencies: [
    {
      coinDenom: "tia",
...
const chain4energytestnet = defineChainInfo({
  chainId: "babajaga-1",
  currencies: [
    {
      coinDenom: "c4e",
...
const cheqdtestnet = defineChainInfo({
...
const chimbatestnet = defineChainInfo({
...
const composabletestnet = defineChainInfo({
...
const coolcattestnet = defineChainInfo({
  chainId: "kitten-04",
  currencies: [
    {
      coinDenom: "ccat",
...
const coreumtestnet = defineChainInfo({
...
const cosmoshubtestnet = defineChainInfo({
...
const cosmwasmtestnet = defineChainInfo({
  chainId: "malaga-420",
  currencies: [
    {
      coinDenom: "MLG",
...
const cosstestnet = defineChainInfo({
...
const deardogetestnet = defineChainInfo({
...
const desmostestnet = defineChainInfo({
...
const dhealthtestnet = defineChainInfo({
...
const doravotatestnet = defineChainInfo({
...
const doravotatestnet2 = defineChainInfo({
  chainId: "vota-vk",
  currencies: [
    {
      coinDenom: "DORA",
...
const dydxtestnet = defineChainInfo({
...
const elystestnet = defineChainInfo({
...
const empetestnet = defineChainInfo({
...
const empowertestnet = defineChainInfo({
  chainId: "circulus-1",
  currencies: [
    {
      coinDenom: "mpwr",
...
const entrypointtestnet = defineChainInfo({
...
const evmostestnet = defineChainInfo({
...
const fetchhubtestnet = defineChainInfo({
  chainId: "dorado-1",
  currencies: [
    {
      coinDenom: "testfet",
...
const fiammatestnet = defineChainInfo({
...
const finschiatestnet = defineChainInfo({
  chainId: "ebony-2",
  currencies: [
    {
      coinDenom: "tfnsa",
...
const galacticatestnet = defineChainInfo({
...
const gitopiatestnet = defineChainInfo({
...
const hedgetestnet = defineChainInfo({
  chainId: "berberis-1",
  currencies: [
    {
      coinDenom: "hedge",
...
const humanstestnet = defineChainInfo({
  chainId: "testnet-1",
  currencies: [
    {
      coinDenom: "heart",
...
const hypersigntestnet = defineChainInfo({
  chainId: "prajna-1",
  currencies: [
    {
      coinDenom: "hid",
...
const impacthubdevnet = defineChainInfo({
  chainId: "devnet-1",
  currencies: [
    {
      coinDenom: "ixo",
...
const impacthubtestnet = defineChainInfo({
  chainId: "pandora-8",
  currencies: [
    {
      coinDenom: "ixo",
...
const imversedtestnet = defineChainInfo({
...
const injectivetestnet = defineChainInfo({
...
const jackaltestnet = defineChainInfo({
  chainId: "canine-1",
  currencies: [
    {
      coinDenom: "jkl",
...
const jackaltestnet2 = defineChainInfo({
  chainId: "mesomelas-1",
  currencies: [
    {
      coinDenom: "jkl",
...
const junotestnet = defineChainInfo({
  chainId: "uni-6",
  currencies: [
    {
      coinDenom: "junox",
...
const kichaintestnet = defineChainInfo({
  chainId: "kichain-t-4",
  currencies: [
    {
      coinDenom: "tki",
...
const kimatestnet = defineChainInfo({
...
const kujiratestnet = defineChainInfo({
  chainId: "harpoon-4",
  currencies: [
    {
      coinDenom: "kuji",
...
const kyvedevnet = defineChainInfo({
  chainId: "korellia-2",
  currencies: [
    {
      coinDenom: "kyve",
...
const kyvetestnet = defineChainInfo({
  chainId: "kaon-1",
  currencies: [
    {
      coinDenom: "kyve",
...
const lavatestnet = defineChainInfo({
...
const lavatestnet1 = defineChainInfo({
...
const likecointestnet = defineChainInfo({
...
const lumenxtestnet = defineChainInfo({
  chainId: "lumenx-test",
  currencies: [
    {
      coinDenom: "lumen",
...
const manifesttestnet = defineChainInfo({
...
const mantrachaintestnet = defineChainInfo({
...
const marstestnet = defineChainInfo({
  chainId: "ares-1",
  currencies: [
    {
      coinDenom: "mars",
...
const migalootestnet = defineChainInfo({
  chainId: "narwhal-2",
  currencies: [
    {
      coinDenom: "whale",
...
const neutrontestnet = defineChainInfo({
  chainId: "pion-1",
  currencies: [
    {
      coinDenom: "ntrn",
...
const nibirudevnet = defineChainInfo({
...
const nibirudevnet2 = defineChainInfo({
...
const nibirudevnet3 = defineChainInfo({
...
const nibirudevnet4 = defineChainInfo({
...
const nibirutestnet = defineChainInfo({
...
const nibirutestnet2 = defineChainInfo({
...
const nilliontestnet = defineChainInfo({
...
const nobletestnet = defineChainInfo({
  chainId: "grand-1",
  currencies: [
    {
      coinDenom: "stake",
...
const noistestnet = defineChainInfo({
...
const nolustestnet = defineChainInfo({
  chainId: "rila-1",
  currencies: [
    {
      coinDenom: "nls",
...
const nyxtestnet = defineChainInfo({
  chainId: "sandbox",
  currencies: [
    {
      coinDenom: "nyx",
...
const okp4testnet = defineChainInfo({
...
const osmosistestnet = defineChainInfo({
  chainId: "osmo-test-5",
  currencies: [
    {
      coinDenom: "osmo",
...
const osmosistestnet4 = defineChainInfo({
  chainId: "osmo-test-4",
  currencies: [
    {
      coinDenom: "osmo",
...
const permtestnet = defineChainInfo({
...
const persistencetestnet = defineChainInfo({
  chainId: "test-core-1",
  currencies: [
    {
      coinDenom: "xprt",
...
const persistencetestnet2 = defineChainInfo({
  chainId: "test-core-2",
  currencies: [
    {
      coinDenom: "xprt",
...
const planqtestnet = defineChainInfo({
...
const pryzmtestnet = defineChainInfo({
  chainId: "indigo-1",
  currencies: [
    {
      coinDenom: "pryzm",
...
const quasartestnet = defineChainInfo({
...
const quicksilvertestnet = defineChainInfo({
  chainId: "rhye-2",
  currencies: [
    {
      coinDenom: "qck",
...
const qwoyntestnet = defineChainInfo({
  chainId: "earendel-1",
  currencies: [
    {
      coinDenom: "qwoyn",
...
const sagatestnet = defineChainInfo({
...
const secretnetworktestnet = defineChainInfo({
  chainId: "pulsar-3",
  currencies: [
    {
      coinDenom: "scrt",
...
const secretnetworktestnet2 = defineChainInfo({
  chainId: "pulsar-2",
  currencies: [
    {
      coinDenom: "scrt",
...
const seidevnet3 = defineChainInfo({
...
const seitestnet = defineChainInfo({
  chainId: "atlantic-1",
  currencies: [
    {
      coinDenom: "sei",
...
const seitestnet2 = defineChainInfo({
  chainId: "atlantic-2",
  currencies: [
    {
      coinDenom: "sei",
...
const selfchaindevnet = defineChainInfo({
  chainId: "self-dev-1",
  currencies: [
    {
      coinDenom: "self",
...
const sgetestnet = defineChainInfo({
...
const sgetestnet4 = defineChainInfo({
...
const sixtestnet = defineChainInfo({
  chainId: "fivenet",
  currencies: [
    {
      coinDenom: "six",
...
const soarchaintestnet = defineChainInfo({
...
const sourcetestnet = defineChainInfo({
...
const stargazetestnet = defineChainInfo({
  chainId: "elgafar-1",
  currencies: [
    {
      coinDenom: "stars",
...
const statesettestnet = defineChainInfo({
...
const stridetestnet = defineChainInfo({
...
const sunrisetestnet = defineChainInfo({
...
const swisstroniktestnet = defineChainInfo({
...
const symphonytestnet = defineChainInfo({
...
const synternettestnet = defineChainInfo({
  chainId: "amber-2",
  currencies: [
    {
      coinDenom: "AMBER",
...
const temporaltestnet = defineChainInfo({
...
const terpnettestnet = defineChainInfo({
  chainId: "90u-4",
  currencies: [
    {
      coinDenom: "terpx",
...
const terpnettestnet2 = defineChainInfo({
  chainId: "90u-2",
  currencies: [
    {
      coinDenom: "terpx",
...
const terra2testnet = defineChainInfo({
  chainId: "pisco-1",
  currencies: [
    {
      coinDenom: "luna",
...
const titantestnet = defineChainInfo({
...
const tucanatestnet = defineChainInfo({
...
const unificationtestnet = defineChainInfo({
...
const uniontestnet = defineChainInfo({
...
const upticktestnet = defineChainInfo({
...
const vincechaintestnet = defineChainInfo({
...
const wardenprotocoltestnet = defineChainInfo({
...
const wavehashtestnet = defineChainInfo({
...
const xiontestnet = defineChainInfo({
...
const zetachaintestnet = defineChainInfo({
